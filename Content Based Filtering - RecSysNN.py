...
print(f"Number of item vectors: {len(item_vecs)}")
print(f"Number of user features: {len(user_features)}")
print(f"Number of item features: {len(item_features)}")
print(f"Number of movies: {len(movie_dict)}")
